...
void add_contact() {
	    if (contact_count >= MAX_CONTACTS) {
		    ...
		    fgets(contacts[contact_count].name, MAX_NAME_LEN, stdin);
		        strtok(contacts[contact_count].name, "\n");

			    printf("电话: ");
			        fgets(contacts[contact_count].phone, MAX_PHONE_LEN, stdin);
				    strtok(contacts[contact_count].phone, "\n");

				        printf("地址: ");
					    fgets(contacts[contact_count].address, MAX_ADDR_LEN, stdin);
					        strtok(contacts[contact_count].address, "\n");
